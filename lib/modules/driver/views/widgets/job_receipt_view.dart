          ...
          child: Column(
            ...
            children: [
              ...
              if (job != null) ...[
                _costRow(
                  'Base Service Charge',
                  (job['baseCharge'] as num?)?.toDouble() ?? 0,
                ),
                if ((job['laborCharges'] as num?) != null &&
                    job['laborCharges'] > 0)
                  _costRow(
                    'Labor Charges',
                    (job['laborCharges'] as num).toDouble(),
                  ),
                if ((job['partsTotal'] as num?) != null &&
                    job['partsTotal'] > 0)
                  _costRow('Parts Cost', (job['partsTotal'] as num).toDouble()),
                if ((job['travelCost'] as num?) != null &&
                    job['travelCost'] > 0)
                  _costRow(
                    'Travel Cost',
                    (job['travelCost'] as num).toDouble(),
                  ),
